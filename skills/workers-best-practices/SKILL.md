...
description: Review and author Cloudflare Workers code against production best practices. Load for Worker code, wrangler.jsonc, bindings, generated types, streaming, floating promises, global state, secrets, observability, security, or common Workers anti-patterns. Retrieve current Cloudflare docs before exact APIs.
---
